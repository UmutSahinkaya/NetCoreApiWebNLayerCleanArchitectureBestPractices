...
public class ProductsController(IProductService productService) : CustomBaseController
{
    ...
    public async Task<IActionResult> GetPagedAll(int pageNumber,int pageSize) => CreateActionResult(await productService.GetAllPagedListAsync(pageNumber,pageSize));
